...
with(data_project,{plot(Sub_metering_1 ~ date_vector ,type="l",xlab=" ",ylab="Energy sub metering")
...
with(data_project,{plot(Sub_metering_1 ~ date_vector ,type="l",xlab=" ",ylab="Energy sub metering")
  lines(Sub_metering_2 ~ date_vector ,type="l",col="red")
  lines(Sub_metering_3 ~ date_vector ,type="l",col="blue")
  legend("topright",lwd=3,legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"))
})